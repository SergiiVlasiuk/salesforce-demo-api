...
public class QuickstartSoapApiSample {
    private static BufferedReader reader = new BufferedReader(
	         new InputStreamReader(System.in));
    EnterpriseConnection connection;
    static String authEndPoint = "https://login.salesforce.com/services/Soap/c/43.0/";

    public static void main(String[] args) {
        QuickstartSoapApiSample sample;
        if (args.length < 1) {
            System.out.println("Using sample with default endpoint: " + authEndPoint);
            sample = new QuickstartSoapApiSample(authEndPoint);
        } else {
            sample = new QuickstartSoapApiSample(args[0]);
        }
        sample.run();
    }
    public void run() {
    ...
    public QuickstartSoapApiSample(String authEndPoint) {
